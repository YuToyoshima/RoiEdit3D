...
//     private FileInfo fi;
    ...
    public MyFileOpener(FileInfo fi) {
        this.fi = fi;
        if (fi!=null) {
            width = fi.width;
            height = fi.height;
...
//                         mode = IJ.GRAYSCALE;
    ...
    public ImagePlus open(boolean show, Object pixels) {
...
// 		Object pixels;
        ...
        fi.nImages = 1; // should be set as 1 
        
//         /* for debug */
//         
//         System.out.println("open(super)"+fi);
//         System.out.println("open(this)"+this.fi);
...
//         if (fi.nImages>1) {
//             /* for debug */
//             System.out.println("MyFileOpener.openStack was called by open(boolean,Object); fi.nImages="+fi.nImages);
//             StackTraceElement[] elements = Thread.currentThread().getStackTrace();
//             for(StackTraceElement element : elements){
//                 System.out.println(element);
//             }
