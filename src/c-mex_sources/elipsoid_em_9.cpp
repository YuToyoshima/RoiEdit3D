...
/* update sigma vector (denoted as cv_k) */
    ...
    for (unsigned int celipsoid=0; celipsoid<numelipsoids; celipsoid++) {
        ...
        if (fixvol==1) {
            ...
            double tmp_S_11 = tmpnum_S_11 * tmpden_inv;
            double tmp_S_12 = tmpnum_S_12 * tmpden_inv;
            double tmp_S_13 = tmpnum_S_13 * tmpden_inv;
            double tmp_S_22 = tmpnum_S_22 * tmpden_inv;
            double tmp_S_23 = tmpnum_S_23 * tmpden_inv;
            double tmp_S_33 = tmpnum_S_33 * tmpden_inv;
