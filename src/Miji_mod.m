function Miji_mod(open_imagej,fiji_directory)
    ...
    if ~exist('fiji_directory','var') || isempty(fiji_directory)
    ...
    %%% the following line is added by Yu Toyoshima
    add_to_classpath(classpath, strcat([fiji_directory filesep 'jars' filesep 'bio-formats']));
